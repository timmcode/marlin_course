...
<body>
    ...
    <main id="assets/js-page-content" role="main" class="page-content mt-3">
        <div class="subheader">
        ...
        <form action="<?=$href_profile_edit?>" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="department" type="text" id="simpleinput" class="form-control" value="<?=$user['department']?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="vk" type="text" id="simpleinput" class="form-control" value="<?=$user['vk']?>">
                                </div>

                                <!-- tg -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Telegram</label>
                                    <input name="tg" type="text" id="simpleinput" class="form-control" value="<?=$user['tg']?>">
                                </div>

                                <!-- ig -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Instagram</label>
                                    <input name="ig" type="text" id="simpleinput" class="form-control" value="<?=$user['ig']?>">
                                </div>
