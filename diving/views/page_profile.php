        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item ">
                        <a class="nav-link" href="<?=$href_home?>">Главная</a>
                    </li>
                </ul>
        ...
        <main id="assets/js-page-content" role="main" class="page-content mt-3">
            <div class="subheader">
                <h1 class="subheader-title">
                    <i class='subheader-icon fal fa-user'></i> <?=$user_info['name']?>
                </h1>
            </div>
            <div class="row">
                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    <img src="assets/img/demo/avatars/avatar-admin-lg.png" class="rounded-circle shadow-2 img-thumbnail" alt="">
